...
/**
 * Tests for MsDosRenderer.
 */
class MsDosRendererTest extends BaseRendererTestCase
{
    protected function getRenderer(): RendererContract
    {
        return new MsDosRenderer();
    }
...
OUTPUT;
    ...
    {
        // Note: MsDosRenderer might have issues with multi-byte alignment depending on font
...
╚════╩══════╝
OUTPUT;
        // Note: MsDosRenderer shows header/footer even with no rows
